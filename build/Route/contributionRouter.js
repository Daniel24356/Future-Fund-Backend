...
contributionRouter.post("/joinContribution", auth_middleware_1.authenticateUser, contributioncontroller.joinContribution);
contributionRouter.post("/:contributionId/payContribution", auth_middleware_1.authenticateUser, contributioncontroller.payContribution);
contributionRouter.get("/members/:contributionId", auth_middleware_1.authenticateUser, contributioncontroller.getAllContributionMembers);
contributionRouter.post("/invite", auth_middleware_1.authenticateUser, contributioncontroller.inviteUsersToContribution);
contributionRouter.post("/:contributionId/join", auth_middleware_1.authenticateUser, contributioncontroller.joinContribution);
...
contributionRouter.post("/:contributionId/start", auth_middleware_1.authenticateUser, contributioncontroller.startContributionCycle);
...
contributionRouter.post("/hold-funds", auth_middleware_1.authenticateUser, contributioncontroller.holdFundsInEscrow);
contributionRouter.post("/:contributionId/:member/penalize", auth_middleware_1.authenticateUser, contributioncontroller.penalizeLatePayers);
